...
joe.suite('badges', function (suite, test) {
	...
	const expectations = [
		...
		`<span class="badge-shields"><a href="url" title="title"><img src="//img.shields.io/badge/left-right-yellow.svg" alt="alt" /></a></span>`,
		`<span class="badge-shields"><a href="url" title="title"><img src="//img.shields.io/badge/left-right-red.svg" alt="alt" /></a></span>`,
		`<br class="badge-separator" />`,
		`<span class="badge-npmversion"><a href="https://npmjs.org/package/getbadges" title="View this project on NPM"><img src="//img.shields.io/npm/v/getbadges.svg" alt="NPM version" /></a></span>`,
		`<span class="badge-npmdownloads"><a href="https://npmjs.org/package/getbadges" title="View this project on NPM"><img src="//img.shields.io/npm/dm/getbadges.svg" alt="NPM downloads" /></a></span>`,
		`<span class="badge-daviddm"><a href="https://david-dm.org/bevry/getbadges" title="View the status of this project's dependencies on DavidDM"><img src="//img.shields.io/david/bevry/getbadges.svg" alt="Dependency Status" /></a></span>`,
		`<span class="badge-daviddmdev"><a href="https://david-dm.org/bevry/getbadges#info=devDependencies" title="View the status of this project's development dependencies on DavidDM"><img src="//img.shields.io/david/dev/bevry/getbadges.svg" alt="Dev Dependency Status" /></a></span>`,
		`<br class="badge-separator" />`,
		`<div class="badge-saucelabsbm"><a href="https://saucelabs.com/u/bevry" title="Check this project's browser tests on Sauce Labs"><img src="//saucelabs.com/browser-matrix/bevry.svg?auth=123" alt="Sauce Labs Browser Matrix" /></a></div>`,
		`<span class="badge-saucelabs"><a href="https://saucelabs.com/u/bevry" title="Check this project's browser tests on Sauce Labs"><img src="//saucelabs.com/browser-matrix/bevry.svg?auth=123" alt="Sauce Labs Browser Matrix" /></a></span>`,
		`<span class="badge-travisci"><a href="http://travis-ci.org/bevry/getbadges" title="Check this project's build status on TravisCI"><img src="//img.shields.io/travis/bevry/getbadges/master.svg" alt="Travis CI Build Status" /></a></span>`,
		`<span class="badge-codeship"><a href="https://www.codeship.io/projects/123" title="Check this project's status on Codeship"><img src="//img.shields.io/codeship/123/master.svg" alt="Codeship Status" /></a></span>`,
		`<span class="badge-coveralls"><a href="https://coveralls.io/r/bevry/getbadges" title="View this project's coverage on Coveralls"><img src="//img.shields.io/coveralls/bevry/getbadges.svg" alt="Coverage Status" /></a></span>`,
		`<span class="badge-waffle"><a href="http://waffle.io/bevry/getbadges" title="View this project's stories on Waffle.io"><img src="//badge.waffle.io/bevry/getbadges.png?label=ready" alt="Stories in Ready" /></a></span>`,
		`<br class="badge-separator" />`,
		...
		`<span class="badge-paypal"><a href="https://paypal.me/bevry" title="Donate to this project using Paypal"><img src="//img.shields.io/badge/paypal-donate-yellow.svg" alt="PayPal donate button" /></a></span>`,
		...
		`<span class="badge-gabeacon"><a href="https://github.com/igrigorik/ga-beacon" title="Get Google Analytics for your project"><img src="//ga-beacon.appspot.com/UA-XXXXX-XX/bevry/getbadges" alt="Google Analytics beacon image" /></a></span>`,
		...
		`<span class="badge-redditsubmit"><script>reddit_url="http://bevry.me"</script><script src="//en.reddit.com/static/button/button1.js"></script></span>`,
		...
		`<span class="badge-githubfollow"><iframe src="//ghbtns.com/github-btn.html?user=balupton&amp;type=follow&amp;count=true" allowtransparency="true" frameborder="0" scrolling="0" width="165" height="20"></iframe></span>`,
		`<span class="badge-githubstar"><iframe src="//ghbtns.com/github-btn.html?user=bevry&amp;repo=getbadges&amp;type=watch&amp;count=true" allowtransparency="true" frameborder="0" scrolling="0" width="110" height="20"></iframe></span>`,
		`<span class="badge-quorafollow"><span data-name="Benjamin-Lupton">Follow <a href="http://www.quora.com/Benjamin-Lupton">Benjamin Arthur Lupton</a> on <a href="http://www.quora.com">Quora</a><script src="//www.quora.com/widgets/follow?embed_code=7N31XJs"></script></span></span>`
	]

...
``` typescript
import * as pkg from 'https://unpkg.com/badges@^4.14.0/edition-deno/index.ts'
```
...
``` html
<script type="module">
    import * as pkg from '//cdn.pika.dev/badges/^4.14.0'
</script>
```
...
``` html
<script type="module">
    import * as pkg from '//unpkg.com/badges@^4.14.0'
</script>
```
...
``` html
<script type="module">
    import * as pkg from '//dev.jspm.io/badges@4.14.0'
</script>
```
